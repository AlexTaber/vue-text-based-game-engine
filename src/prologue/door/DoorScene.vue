<template>
  <Scene name="door" @finish="setActive('elevator')">
    <SceneLog>
    ...
    <SceneSelect>
      <SceneSelectOption value="">
        The silverish gold key
      </SceneSelectOption>

      <SceneSelectOption value="">
        The goldish silver key
      </SceneSelectOption>
    </SceneSelect>

    <SceneLog>
      You pick the wrong key. You should really put tape on one of them...
    </SceneLog>
